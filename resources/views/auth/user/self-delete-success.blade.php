...
@section('content')
    ...
    <div class="mx-5 py-[200px] flex justify-center">
        ...
        @if (session('status'))
            <div class=" mb-2 flex p-4 text-xl text-green-800 border border-green-300 rounded-2xl bg-green-50 dark:bg-[#454547] dark:text-green-400 dark:border-green-800"
                role="alert">
