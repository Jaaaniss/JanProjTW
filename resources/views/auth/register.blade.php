        ...
        <div class="bg-transparent">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="dark:bg-[#4a4a4c] flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                    ...
                    <input class="bg-transparent pl-2 outline-none border-none" type="text" name="name" id=""
                ...
                <div class="dark:bg-[#4a4a4c] flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                    ...
                    <input type="password" class="bg-transparent  pl-2 outline-none border-none" name="password" id=""
                ...
                <div class="dark:bg-[#4a4a4c] flex items-center border-2 py-2 px-3 rounded-2xl">
                    ...
                    <input name="password_confirmation" type="password"
                        class="bg-transparent pl-2 outline-none border-none" id="Passwordd"
