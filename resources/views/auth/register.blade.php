                ...
                <div class="w-[400px] bg-transparent">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div
                            ...
                            <input
                                class="border-transparent focus:border-transparent focus:ring-0 bg-transparent pl-2 outline-none border-none"
                        ...
                        <div
                            ...
                            <input name="password_confirmation" type="password"
                                class="border-transparent focus:border-transparent focus:ring-0 bg-transparent pl-2 outline-none border-none"
                                id="Passwordd" placeholder="Confirm Password" required autocomplete="current_password"
                                autofocus>
                        </div>
