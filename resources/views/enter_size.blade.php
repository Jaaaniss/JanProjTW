            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Enter your size</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div
            ...
            <div class=" px-8 pb-8 pt-1 ">
                ...
                <div class="mt-4 space-y-4 lg:mt-5 md:space-y-5">
                    ...
                    <div>
                        <label for="name" class="flex justify-left block mb-5 text-lg font-medium text-gray-900 dark:text-white">
                        ...
                        <div>
                            <form action="/enter_size" method="post">
                                ...
                                <div class="relative flex justify-center">
                                    <input id="sizeinput" type=number step=0.01 name="foot_size_cm" class="flex justify-center block w-full p-3 text-sm text-gray-900 border border-gray-300 rounded-xl bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-[#323232] dark:border-transparent dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter a number">
