                ...
                <div>
                    ...
                    <div>
                        <form action="/enter_size" method="post">
                            ...
                            <div class="relative">
                                <input id="sizeinput" max="1000"  name="foot_size_cm" type="number" class="block w-full p-3 text-sm text-gray-900 border border-gray-300 rounded-xl bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-[#323232] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter a number">
