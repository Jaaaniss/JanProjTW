...
@section('content')
    ...
    @role('Admin')
        <div class="mx-5 py-[226.5px] flex flex-col items-center">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ url("manage_tables/manage_$company") }}"
                                class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{ $company }}</a>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
                ...
                <form class="px-6 py-6 " action="{{ url('update/' . $item->id . '/' . $company) }}" method="POST">
                    ...
                    <div class="flex flex-col gap-6 mb-6 md:grid-cols-2">
                        <div>
                            ...
                            <input step=0.01 type="number" name="CM" value="{{ $item->cm }}"
                        ...
                        <div>
                            ...
                            <input step=0.01 type="text" name="EU" value="{{ $item->eu }}"
                        ...
                        <div>
                            ...
                            <input step=0.01 type="number" name="UK" value="{{ $item->uk }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#323232] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required>
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">US M</label>
                            <input step=0.01 type="number" name="US_M" value="{{ $item->usm }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#323232] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" required>
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">US W</label>
                            <input step=0.01 type="text" name="US_W" value="{{ $item->usw }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#323232] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                    </div>
                    <div class="flex flex-row justify-between">
                        <button type="submit"
                            class="mr-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update</button>
                        <a href="{{ url("manage_tables/manage_$company") }}"
