                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Nike</span>
                        </div>
                    </li>
                </ol>
            </nav>
                ...
                <div
                    ...
                    <div class='py-3'>
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                            ...
                            type="button">Nike<svg class="w-4 h-4 ml-2" aria-hidden="true" fill="none" stroke="currentColor"
                            ...
                            @foreach ($nike as $item2)
                                <tr class=" border-b dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-[#585858]">
                                    ...
                                    <td
                                        ...
                                        <div class="stails">
                                            <a href="{{ url('manage_tables/edit/edit/' . $item2->id . '/Nike') }}"
