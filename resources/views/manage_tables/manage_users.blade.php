...
@section('content')
    ...
    @role('Admin')
        <div class="mx-5 pt-[200px] pb-[610px] flex flex-col items-center">
            ...
            <div
                ...
                <div
                    class="bg-white dark:bg-[#454547] border-b-[1px] border-zinc-200 dark:border-zinc-500 flex items-center justify-between">
                    <div class='py-3'>
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                            ...
                            type="button">Users<svg class="w-4 h-4 ml-2" aria-hidden="true" fill="none"
